...
def load_page1():
    from pages.app2.page1 import main
    main()
    
def load_page2():
    from pages.app2.page2 import main
    main()

def load_page3():
    from pages.app2.page3 import main
    main()

def load_page4():
    from pages.app2.page4 import main
    main()

def load_page5():
    from pages.app2.page5 import main
    main()
